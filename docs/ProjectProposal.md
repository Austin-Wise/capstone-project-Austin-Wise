...
### <a name="three_one"></a>3.1 Jimmy Lee  *#investingnoobie*
...
> 
> **Bio:** Miriam, a registered nurse, has been putting away a portion of her salary since college. Though she manages her finances well, she feels she doesn't have the time to exercise strategies necessary for better returns. 
> 
> |Technology Confidence|   |
> |--|--|
> | IT and Internet | •••• |
...
> ### Quickly checking investment news during break
>
> 1. (0:05) **Navigate to Site**
> 2. **Login**\
> (0:07) OAuth with Facebook / Google\
> *or*\
> (0:15) User / Password
> 3. (0:04) **Locate Saved Ticker-Symbol on left-hand panel**
> 4. (0:03) **Filter results by desired time**
> 5. (~1:30) **Browse articles, taking note of sentiment rating**
> 6. (0:01) **Save interesting articles to reading list for later**
> 7. Eat Lunch :grin: :bento:\
> Elapsed Time: ~ 1:50 - 1:58 (+1:30 per ticker-feed)\
**(minutes:seconds)*
...
> | Social Networks| •••• |
>
>**Hobbies:** Tennis, Cooking, Golf, Painting 
