...
As I haven't touched Adobe XD for some time, I am concerned about major updates in the tooling and a possible need to renew my Adobe license. There are free tools avalilable - such as Figma, which, if needed can perform the same actions.
...
If I can get better at troubleshooting migration issues, I dont see any problems using sequelize.
